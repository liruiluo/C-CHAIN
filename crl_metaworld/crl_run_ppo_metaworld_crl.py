...
def eval_policy_metaworld(
    ...
    for _ in range(eval_episodes):
        ...
        while not done:
            ...
            action = eval_agent.select_action(obs_t, deterministic=True)[0]
...
class Args:
    ...
    alg: str = "ppo_relu_metaworld_chain"
...
if __name__ == "__main__":
    ...
    for task_idx, env_name in enumerate(args.tasks):
        ...
        os.makedirs("results/metaworld_ppo_crl", exist_ok=True)
        save_path = os.path.join(
            "results/metaworld_ppo_crl",
